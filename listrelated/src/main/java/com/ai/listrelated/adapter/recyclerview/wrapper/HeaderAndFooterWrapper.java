 ...
 * <b>Description:</b> RecyclerView.Adapter的包装使其支持Header And Footer <br>
 */
public class HeaderAndFooterWrapper<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    /**
     * 必须传递进来需要包裹的实现了{@link RecyclerView.Adapter}的Adapter
     *
     ...
     * 是否是Header
     *
     * @param position position的位置比HeaderView的个数小
     * @return
     */
     ...
     * 是否是Footer
     *
     * @param position position的位置比HeaderView个数+普通item的个数大
     * @return
     */
